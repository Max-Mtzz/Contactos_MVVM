...
import com.example.contactos_mvvm.ui.components.images.CircularImage
import com.example.contactos_mvvm.ui.components.inputs.PasswordField
import com.example.contactos_mvvm.ui.components.inputs.UserInputField
import com.example.contactos_mvvm.ui.components.texts.Link
...
fun LoginScreen(viewModel: LoginViewModel, navController: NavController) {
    Column(
        ...
        CircularImage(R.drawable.contacto__1_)
        Title("Contactos\n")
        ...
        PrimaryButton("Iniciar sesión") {
            viewModel.login {
                navController.navigate("verContactos") {
